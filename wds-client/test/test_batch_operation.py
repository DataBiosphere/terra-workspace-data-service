...
from openapi_client.models.batch_operation import BatchOperation  # noqa: E501
...
class TestBatchOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.batch_operation.BatchOperation()  # noqa: E501
        if include_optional :
            return BatchOperation(
                operation = 'upsert', 
                record = openapi_client.models.batch_record_request.BatchRecordRequest(
                    id = '0', 
                    type = '0', 
                    attributes = {
  "stringAttr": "string",
