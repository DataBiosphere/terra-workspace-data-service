...
CREATE TABLE "public"."entity" ("entity_type" BIGINT NOT NULL, "name" VARCHAR NOT NULL, "deleted" BOOLEAN NOT NULL, "attributes" JSONB NOT NULL, CONSTRAINT "entity_pkey" PRIMARY KEY ("entity_type", "name"));
...
CREATE TABLE "public"."entity_attribute_info" ("entity_type" BIGINT NOT NULL, "entity_name" VARCHAR NOT NULL, "entity_attribute_values" VARCHAR, "entity_attribute_names" VARCHAR[] DEFAULT ARRAY[]::character varying[], CONSTRAINT "entity_attribute_concat_pkey" PRIMARY KEY ("entity_type", "entity_name"));
