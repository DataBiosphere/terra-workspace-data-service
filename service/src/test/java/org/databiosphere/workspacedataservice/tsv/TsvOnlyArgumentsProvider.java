 ...
 *
 * <p>The fixtures in here cause JSON parsing errors but are allowed for TSVs.
 *
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
    ...
    */
    return Stream.of(
        ...
        Arguments.of(
            "“Hello world”",
            "“Hello world”"), // smart quotes around a scalar: keep the smart quotes
        Arguments.of(
            "\"“Hello world”\"",
            "“Hello world”"), // smart quotes inside a quoted string: keep the smart quotes
        Arguments.of(
            "[“test1”, “test2”]",
            Arrays.asList("test1", "test2")), // smart quotes inside an array: strip quotes
        ...
        // these could be enabled in JSON by turning on
        // JsonReadFeature.ALLOW_LEADING_ZEROS_FOR_NUMBERS in the mapper
        ...
        // these could be enabled in JSON by turning on
        // JsonReadFeature.ALLOW_LEADING_DECIMAL_POINT_FOR_NUMBERS in the mapper
