...
public class ParquetRecordConverter extends AvroRecordConverter {
  ...
  // TODO AJ-1774: if we handle [{"element":x}, {"element":y}] Parquet serialization at a deeper
  //   level, is this method still necessary?
  private String unwrapArrayValue(Object relationArrayValue) {
    if (relationArrayValue instanceof GenericData.Record rec && isRelationArrayValue(rec)) {
      return String.valueOf(rec.get("element"));
    }
  ...
  private boolean isRelationArrayValue(GenericData.Record rec) {
