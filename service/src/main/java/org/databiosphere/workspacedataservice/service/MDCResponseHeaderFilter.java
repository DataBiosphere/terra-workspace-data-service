...
/**
 * Servlet filter that inspects the SLF4J MDC context and propagates any
 * "requestId" value it finds in MDC to an "x-b3-traceid" response header.
 * <p>
 * See also {@link MDCServletRequestListener}, which looks in the MDC context
 * for a request id and adds it to response headers if found.
 */
@Component
