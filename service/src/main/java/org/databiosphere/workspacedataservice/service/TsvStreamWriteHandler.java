...
/**
 * Accepts a Stream of Records previously generated by the Jackson CsvMapper and WDS's TsvConverter;
 * grabs the next N records from the stream and returns a WriteStreamInfo that batch of Records.
 */
