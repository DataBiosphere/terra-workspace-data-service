...
public class CloningController {
  ...
  public ResponseEntity<Job<BackupResponse>> createBackup(
      @PathVariable("version") String version,
      @RequestBody BackupRestoreRequest BackupRestoreRequest) {
    UUID trackingId = UUID.randomUUID();
    // TODO: make async
    Job<BackupResponse> backupJob =
  ...
  public ResponseEntity<Job<BackupResponse>> getBackupStatus(
  ...
  public ResponseEntity<Job<CloneResponse>> getCloningStatus(
      @PathVariable("version") String version) {
    validateVersion(version);
